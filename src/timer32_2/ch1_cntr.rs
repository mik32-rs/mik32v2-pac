#[doc = "Register `CH1_CNTR` reader"]
pub type R = crate::R<Ch1CntrSpec>;
#[doc = "Register `CH1_CNTR` writer"]
pub type W = crate::W<Ch1CntrSpec>;
...
impl W {
    #[doc = "Bit 0 - Управление фильтрацией входных помех на входе ic_port: 0 – фильтрация выклю-чена; 1 – фильтрация выклю-чена"]
    #[inline(always)]
    pub fn noise(&mut self) -> NoiseW<Ch1CntrSpec> {
        NoiseW::new(self, 0)
    }
    #[doc = "Bit 4 - Режим сигнала захвата"]
    #[inline(always)]
    pub fn edge(&mut self) -> EdgeW<Ch1CntrSpec> {
        EdgeW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Режим работы канала"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Ch1CntrSpec> {
        ModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Включение/выключение канала"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Ch1CntrSpec> {
        EnW::new(self, 7)
    }
    #[doc = "Bit 8 - Тип вывода в режиме ШИМ инвертирование"]
    #[inline(always)]
    pub fn pwm_inv(&mut self) -> PwmInvW<Ch1CntrSpec> {
        PwmInvW::new(self, 8)
    }
}
...
pub struct Ch1CntrSpec;
impl crate::RegisterSpec for Ch1CntrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch1_cntr::R`](R) reader structure"]
impl crate::Readable for Ch1CntrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch1_cntr::W`](W) writer structure"]
impl crate::Writable for Ch1CntrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH1_CNTR to value 0"]
impl crate::Resettable for Ch1CntrSpec {
