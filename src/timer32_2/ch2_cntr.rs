#[doc = "Register `CH2_CNTR` reader"]
pub type R = crate::R<Ch2CntrSpec>;
#[doc = "Register `CH2_CNTR` writer"]
pub type W = crate::W<Ch2CntrSpec>;
...
impl W {
    #[doc = "Bit 0 - Управление фильтрацией входных помех на входе ic_port: 0 – фильтрация выклю-чена; 1 – фильтрация выклю-чена"]
    #[inline(always)]
    pub fn noise(&mut self) -> NoiseW<Ch2CntrSpec> {
        NoiseW::new(self, 0)
    }
    #[doc = "Bit 4 - Режим сигнала захвата"]
    #[inline(always)]
    pub fn edge(&mut self) -> EdgeW<Ch2CntrSpec> {
        EdgeW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Режим работы канала"]
    #[inline(always)]
    pub fn mode(&mut self) -> ModeW<Ch2CntrSpec> {
        ModeW::new(self, 5)
    }
    #[doc = "Bit 7 - Включение/выключение канала"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Ch2CntrSpec> {
        EnW::new(self, 7)
    }
    #[doc = "Bit 8 - Тип вывода в режиме ШИМ инвертирование"]
    #[inline(always)]
    pub fn pwm_inv(&mut self) -> PwmInvW<Ch2CntrSpec> {
        PwmInvW::new(self, 8)
    }
}
...
pub struct Ch2CntrSpec;
impl crate::RegisterSpec for Ch2CntrSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`ch2_cntr::R`](R) reader structure"]
impl crate::Readable for Ch2CntrSpec {}
#[doc = "`write(|w| ..)` method takes [`ch2_cntr::W`](W) writer structure"]
impl crate::Writable for Ch2CntrSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets CH2_CNTR to value 0"]
impl crate::Resettable for Ch2CntrSpec {
