#[doc = "Register `DAC1_CFG` reader"]
pub type R = crate::R<Dac1CfgSpec>;
#[doc = "Register `DAC1_CFG` writer"]
pub type W = crate::W<Dac1CfgSpec>;
...
impl W {
    #[doc = "Bit 0 - Управление питанием ЦАП"]
    #[inline(always)]
    pub fn en(&mut self) -> EnW<Dac1CfgSpec> {
        EnW::new(self, 0)
    }
    #[doc = "Bit 1 - Управление сбросом ЦАП, активный уровень «0»"]
    #[inline(always)]
    pub fn rn(&mut self) -> RnW<Dac1CfgSpec> {
        RnW::new(self, 1)
    }
    #[doc = "Bits 2:9 - Значение делителя тактового сигнала. Частота определяется как FЦАП=FIN/(DIV+1)"]
    #[inline(always)]
    pub fn div(&mut self) -> DivW<Dac1CfgSpec> {
        DivW::new(self, 2)
    }
    #[doc = "Bit 10 - Выбор источника опорного напряжения"]
    #[inline(always)]
    pub fn exten(&mut self) -> ExtenW<Dac1CfgSpec> {
        ExtenW::new(self, 10)
    }
    #[doc = "Bit 11 - Выбор источника внешнего опорного напряжения"]
    #[inline(always)]
    pub fn extpad(&mut self) -> ExtpadW<Dac1CfgSpec> {
        ExtpadW::new(self, 11)
    }
}
...
pub struct Dac1CfgSpec;
impl crate::RegisterSpec for Dac1CfgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`dac1_cfg::R`](R) reader structure"]
impl crate::Readable for Dac1CfgSpec {}
#[doc = "`write(|w| ..)` method takes [`dac1_cfg::W`](W) writer structure"]
impl crate::Writable for Dac1CfgSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DAC1_CFG to value 0"]
impl crate::Resettable for Dac1CfgSpec {
