...
#[repr(u8)]
pub enum Trigsel {
    #[doc = "0: Источник триггера GPIO1_9"]
    Gpio1_9 = 0,
    #[doc = "1: Источник триггера GPIO1_8"]
    Gpio1_8 = 1,
    #[doc = "2: Источник триггера GPIO1_7"]
    Gpio1_7 = 2,
    #[doc = "3: Источник триггера GPIO1_6"]
    Gpio1_6 = 3,
...
impl TrigselR {
    ...
    #[doc = "Источник триггера GPIO1_9"]
    #[inline(always)]
    pub fn is_gpio1_9(&self) -> bool {
        *self == Trigsel::Gpio1_9
    }
    #[doc = "Источник триггера GPIO1_8"]
    #[inline(always)]
    pub fn is_gpio1_8(&self) -> bool {
        *self == Trigsel::Gpio1_8
    }
    #[doc = "Источник триггера GPIO1_7"]
    #[inline(always)]
    pub fn is_gpio1_7(&self) -> bool {
        *self == Trigsel::Gpio1_7
    }
    #[doc = "Источник триггера GPIO1_6"]
    #[inline(always)]
    pub fn is_gpio1_6(&self) -> bool {
        *self == Trigsel::Gpio1_6
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn gpio1_9(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio1_9)
    }
    #[doc = "Источник триггера GPIO1_8"]
    #[inline(always)]
    pub fn gpio1_8(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio1_8)
    }
    #[doc = "Источник триггера GPIO1_7"]
    #[inline(always)]
    pub fn gpio1_7(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio1_7)
    }
    #[doc = "Источник триггера GPIO1_6"]
    #[inline(always)]
    pub fn gpio1_6(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio1_6)
    }
    #[doc = "Источник триггера - окончание преобразования термосенсора"]
    #[inline(always)]
