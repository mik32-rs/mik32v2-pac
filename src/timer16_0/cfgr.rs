...
#[repr(u8)]
pub enum Trigsel {
    #[doc = "0: Источник триггера GPIO0_7"]
    Gpio0_7 = 0,
    #[doc = "1: Источник триггера GPIO0_4"]
    Gpio0_4 = 1,
    #[doc = "2: Источник триггера GPIO0_15"]
    Gpio0_15 = 2,
    #[doc = "3: Источник триггера GPIO0_14"]
    Gpio0_14 = 3,
...
impl TrigselR {
    ...
    #[doc = "Источник триггера GPIO0_7"]
    #[inline(always)]
    pub fn is_gpio0_7(&self) -> bool {
        *self == Trigsel::Gpio0_7
    }
    #[doc = "Источник триггера GPIO0_4"]
    #[inline(always)]
    pub fn is_gpio0_4(&self) -> bool {
        *self == Trigsel::Gpio0_4
    }
    #[doc = "Источник триггера GPIO0_15"]
    #[inline(always)]
    pub fn is_gpio0_15(&self) -> bool {
        *self == Trigsel::Gpio0_15
    }
    #[doc = "Источник триггера GPIO0_14"]
    #[inline(always)]
    pub fn is_gpio0_14(&self) -> bool {
        *self == Trigsel::Gpio0_14
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn gpio0_7(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio0_7)
    }
    #[doc = "Источник триггера GPIO0_4"]
    #[inline(always)]
    pub fn gpio0_4(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio0_4)
    }
    #[doc = "Источник триггера GPIO0_15"]
    #[inline(always)]
    pub fn gpio0_15(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio0_15)
    }
    #[doc = "Источник триггера GPIO0_14"]
    #[inline(always)]
    pub fn gpio0_14(self) -> &'a mut crate::W<REG> {
        self.variant(Trigsel::Gpio0_14)
    }
    #[doc = "Источник триггера - окончание преобразования термосенсора"]
    #[inline(always)]
